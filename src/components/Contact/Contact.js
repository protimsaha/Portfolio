                ...
                <div class="hero-content flex-col lg:flex-row">
                    ...
                    <div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 p-5">
                        ...
                        <form action="https://formsubmit.co/protimsaha750@gmail.com" method="POST">
                            <input type="text" placeholder="Your Email" class="input input-bordered w-full my-4" />
                            <input type="text" placeholder="Your Name" class="input input-bordered w-full my-4" />
                            <textarea rows={5} cols={5} type="text" placeholder="Message" class="input input-bordered w-full my-4" />
