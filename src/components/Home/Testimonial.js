    ...
    return (
        <div className='feedback min-h-[60vh] '>
            ...
            <form onSubmit={update} className='flex-col flex '>
                <input type="text" name='name' placeholder="Your name" class="input input-bordered input-secondary mx-auto w-2/3 my-5" />
                <input type="text" name='location' placeholder="Your Location" class="input input-bordered input-secondary mx-auto w-2/3 my-5" />
                <input type="text" placeholder="Your email" name='email' class="input input-bordered input-secondary mx-auto w-2/3 my-5" />
